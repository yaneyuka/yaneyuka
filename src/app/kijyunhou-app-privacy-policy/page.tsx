export default function KijyunhouAppPrivacyPolicyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 md:py-12">
      <div className="flex items-baseline mb-3">
        <h2 className="text-lg font-semibold">建築基準法yaneyuka プライバシーポリシー</h2>
      </div>
      <div className="bg-white p-4 rounded border border-gray-300 text-[13px] leading-6 text-gray-800 space-y-3">
        <p>本ポリシーは、yaneyuka（以下「当アプリ」）が提供するサービスにおける個人情報の取扱いを定めるものです。会員登録・お問い合わせ・サービス利用時に取得する情報の利用目的、保護体制等について定めます。</p>
        <div>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>サブスクリプション情報（購入履歴、サブスクリプション状態）</li>
            <li>デバイス情報（プラットフォーム、アプリ識別子）</li>
          </ul>
        </div>
        <div>
        ...
        <div>
          ...
          <p>サブスクリプション管理のため、RevenueCat（<a href="https://www.revenuecat.com/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 underline">https://www.revenuecat.com/</a>）に情報を提供します。</p>
          <p>課金処理のため、App Store（Apple Inc.）またはGoogle Play（Google LLC）に情報を提供します。これらのサービス提供者は、それぞれのプライバシーポリシーに従って情報を処理します。</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p>法令やサービス内容の変更に伴い、本ポリシーを改定することがあります。重要な変更は当アプリ内または公式サイト上で告知します。</p>
        </div>
        <div>
          <h3 className="font-semibold mb-1">9. お問い合わせ</h3>
          <p>本ポリシーに関するお問い合わせは、以下までご連絡ください。<br />メール: info@yaneyuka.com</p>
        </div>
      </div>
    </div>
  );
